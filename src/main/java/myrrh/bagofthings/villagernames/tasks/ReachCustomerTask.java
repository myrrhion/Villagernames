...
package myrrh.bagofthings.villagernames.tasks;
...
public class ReachCustomerTask extends MultiTickTask<VillagerEntity> {
    private final float speed;

    public ReachCustomerTask(float speed) {
    ...
    protected boolean shouldRun(ServerWorld serverWorld, VillagerEntity villagerEntity) {
        ...
        return villagerEntity.isAlive() && playerEntity != null && !villagerEntity.isTouchingWater() && !villagerEntity.velocityModified && villagerEntity.squaredDistanceTo(playerEntity) <= 9.0;
    }
